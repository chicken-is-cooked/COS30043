...
window.JOBS = [
  {
    ...
    job_description: `Join our AI team to assist with model training, evaluation,
and data preprocessing. You will contribute to real-world projects and gain hands-
on experience in machine learning pipelines and automation tools.`,
  ...
  },
  {
    ...
    job_description: `Support the analytics team by preparing datasets,
generating dashboards, and assisting with predictive modeling. This role is ideal
for someone passionate about data storytelling and visualization.`,
  ...
  },
  {
    ...
    job_description: `Work closely with researchers to build and evaluate AI
models. Responsibilities include literature reviews, experimentation, and
documenting findings for publication or internal reports.`,
  ...
  },
  {
    ...
    job_description: `Build responsive web applications with an agile team.
You'll work across the stack, contribute to design decisions, and implement
efficient, scalable code with modern frameworks.`,
  ...
  },
  {
    ...
    job_description: `Automate infrastructure and deployment pipelines. You'll
maintain cloud environments and ensure system reliability, security, and
performance across distributed platforms.`,
  ...
  },
  {
    ...
    job_description: `Assist the analytics team in extracting insights from large
datasets. You'll clean and analyze data, build reports, and present findings to
internal stakeholders.`,
  ...
  },
  {
    ...
    job_description: `Support a research project focused on natural language
understanding. You'll annotate datasets, evaluate model outputs, and help refine
NLP workflows.`,
  ...
  },
  {
    ...
    job_description: `Assist in developing and testing computer vision models for
real-world applications. You'll work on preprocessing, data labeling, and
performance evaluation tasks.`,
  ...
  },
  {
    ...
    job_description: `Monitor, analyze, and respond to security incidents. You'll
secure systems and networks, perform audits, and implement preventive controls
against cyber threats.`,
  ...
  },
  {
    ...
    job_description: `Design and implement reinforcement learning algorithms for
intelligent decision-making. You'll build simulations, train agents, and analyze
model behavior under various environments.`,
    application_deadline: "2025-04-30",
    posted_date: "2025-03-29",
    company: "AlphaMotion",
