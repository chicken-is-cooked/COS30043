...
const JOBS = [
  {
    ...
    job_description: `Join our AI team to assist with model training, evaluation, and data preprocessing. 
You will contribute to real-world projects and gain hands-on experience in machine learning pipelines and automation tools.`,
  ...
  },
  {
    ...
    job_description: `Support the analytics team by preparing datasets, generating dashboards, and assisting with predictive modeling. 
This role is ideal for someone passionate about data storytelling and visualization.`,
  ...
  },
  {
  ...
  },
   {
    ...
    job_description: `Assist in developing and testing computer vision models for real-world applications.
    You'll work on preprocessing, data labeling, and performance evaluation tasks.`,
  ...
  },
  {
    ...
    job_description: `Monitor, analyze, and respond to security incidents. You'll secure systems and networks,
    perform audits, and implement preventive controls against cyber threats.`,
  ...
  },
  {
    ...
    job_description: `Design and implement reinforcement learning algorithms for intelligent decision-making.
    You'll build simulations, train agents, and analyze model behavior under various environments.`,
    application_deadline: "2025-04-30",
    posted_date: "2025-03-29",
    company: "AlphaMotion",
...
// Component chi tiết: lấy job theo :id
const JobDetail = {
...
// Gợi ý khi chưa chọn
const Hint = { template: '#hint-tpl' };

// Router chỉ điều khiển vùng chi tiết
...
// App: luôn hiện danh sách job_id ở trên, router-view ở dưới
const App = {
  template: '#app-tpl',
  data() {
    return { jobs: JOBS };
